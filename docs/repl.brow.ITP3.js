...
},{"./ITP2":5,"./globalDef":9}],5:[function(require,module,exports){
'use strict';
...
},{"./globalDef":9}],6:[function(require,module,exports){
"use strict";
...
// )
// }
},{"../ITP.pver":4,"../ITP2":5,"../globalDef":9}],7:[function(require,module,exports){
"use strict";
...
},{"../globalDef":9,"parsimmon":10}],8:[function(require,module,exports){
"use strict";
...
const ask_for_input_tactic = warn => s => function* () {
    let ret_ = "";
    let ret = undefined;
    while (ret === undefined) {
        try {
...
const ask_for_input_instr = warn => s => function* () {
    let ret_ = "";
    let ret = undefined;
    while (ret === undefined) {
        try {
...
},{"../globalDef":9,"./console.ITP3":6,"./parser.ITP3":7}],9:[function(require,module,exports){
"use strict";

const debug = s => undefined; // console.log(s + "\n");
const warn = s => undefined;
